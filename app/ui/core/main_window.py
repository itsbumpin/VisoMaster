...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonMediaAudio = QPushButton(self.mediaLayout)
        self.buttonMediaAudio.setObjectName(u"buttonMediaAudio")
        sizePolicy3.setHeightForWidth(self.buttonMediaAudio.sizePolicy().hasHeightForWidth())
        self.buttonMediaAudio.setSizePolicy(sizePolicy3)
        self.buttonMediaAudio.setMaximumSize(QSize(100, 16777215))
        icon4 = QIcon()
        icon4.addFile(u":/media/media/audio_off.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon4.addFile(u":/media/media/audio_on.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        icon4.addFile(u":/media/media/audio_off.png", QSize(), QIcon.Mode.Disabled, QIcon.State.Off)
        icon4.addFile(u":/media/media/audio_on.png", QSize(), QIcon.Mode.Disabled, QIcon.State.On)
        self.buttonMediaAudio.setIcon(icon4)
        self.buttonMediaAudio.setCheckable(True)
        self.buttonMediaAudio.setFlat(True)
        self.horizontalLayoutMediaButtons.addWidget(self.buttonMediaAudio)
